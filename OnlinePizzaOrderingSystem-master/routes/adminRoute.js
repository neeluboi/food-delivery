...
// addpizza data
router.post("/addpizza", verifyToken, uploadOptions.single('image'), (req, res, next) => {
...
router.post("/editpizzawithimage", verifyToken, uploadOptions.single('image'), (req, res, next) => {
    var file = req.file
